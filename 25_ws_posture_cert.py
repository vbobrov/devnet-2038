# Reference: https://developer.cisco.com/docs/pxgrid/subscribing-to-posture-topic/#java-sample-code
...
visibility_topic=service_info["properties"]["postureVisibilityTopic"]
